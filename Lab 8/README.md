# **Lab 08 Student Data Management System**  
...
Do Not remove the README.md and test files.
...
## **Submission**
Please zip the folder and submit it on Canvas slot for Lab 08. <br/> Name the folder as `Your_Last_Name_CWID`
